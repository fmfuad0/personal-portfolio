        ...
        >
            ...
            >
                <g className="lines" style={{ opacity: 0.05 }}>
                    ...
                    <rect className="line" x="873.3" width="1.8" height="1080" fill="#4C3A90" />
                    <rect className="line" x="1100" width="1.8" height="1080" fill="#4C3A90" />
                    <rect className="line" x="1547.1" width="4.5" height="1080" fill="#4C3A90" />
                    <rect className="line" x="615" width="4.5" height="1080" fill="#4C3A90" />
                    <rect className="line" x="684.6" width="1.8" height="1080" fill="#4C3A90" />
                    <rect className="line" x="1369.4" width="1.8" height="1080" fill="#4C3A90" />
                    <rect className="line" x="1310.2" width="0.9" height="1080" fill="#4C3A90" />
                    <rect className="line" x="1233.4" width="0.9" height="1080" fill="#4C3A90" />
                    <rect className="line" x="165.2" width="0.9" height="1080" fill="#4C3A90" />
                    <rect className="line" x="1818.4" width="4.5" height="1080" fill="#4C3A90" />
                    <rect className="line" x="70.3" width="4.5" height="1080" fill="#4C3A90" />
                    <rect className="line" x="1618.6" width="1.8" height="1080" fill="#4C3A90" />
                    <rect className="line" x="455.9" width="1.8" height="1080" fill="#4C3A90" />
                    <rect className="line" x="328.7" width="1.8" height="1080" fill="#4C3A90" />
                    <rect className="line" x="300.8" width="4.6" height="1080" fill="#4C3A90" />
                ...
                <g className="lights" style={{ opacity: 0.9, fill: "#f6b846" }}>
                    ...
                    <path
                        className="light8"
                        d="M165.1,514.5h-0.9v-9.7h0.9V514.5z M165.1,243.6h-0.9v-58.9h0.9V243.6z"
                    />
