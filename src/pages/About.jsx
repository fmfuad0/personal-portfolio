...
const About = () => {
    return (
        <div className={`bg-[var(--color-bg)]`}>
            ...
            <div className={`fading-border border-[thin]`}>
                <h1 className={`text-white p-5 text-xl font-semibold`}><span className={`text-[var(--color-accent)]`}>P</span>rogramming and Development </h1>
            </div>
            <div className={`px-6 py-2`}>
                <div className={`text-gray-400 py-2 flex gap-5 justify-center`}>
                    <div className={`max-w-[48%]`}>
                        ...
                        <strong className={`block text-white`}>Frontend Development</strong>
                    ...
                    <div className={`max-w-[48%]`}>
                        ...
                        <strong className={`block text-white`}>Backend Development</strong>
            ...
            <div className={`px-6 py-2 w-[80%] mx-auto`}>
                <div className={`text-gray-400 py-2 flex gap-5 justify-center`}>
                    <div className={`px-10 `}>
                        ...
                        <strong className={`block  text-center text-white`}>Problem Solving</strong>
